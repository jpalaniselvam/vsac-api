...
export class UtilityClient {
    ...
    async getProgram(programName: string): Promise<ProgramWithReleases> {
        ...
        return this.client.get(`/vsac/program/${encodeURIComponent(programName)}`) as Promise<ProgramWithReleases>;
    }
    ...
    async getOidPrograms(oid: string): Promise<ProgramsResponse> {
        ...
        return this.client.get(`/vsac/oid/${encodeURIComponent(oid)}/programs`) as Promise<ProgramsResponse>;
    }
    ...
    async getOidProgram(oid: string, programName: string): Promise<ProgramWithReleases> {
        ...
        return this.client.get(`/vsac/oid/${encodeURIComponent(oid)}/program/${encodeURIComponent(programName)}`) as Promise<ProgramWithReleases>;
    }
    ...
    async getProgramLatestProfile(programName: string): Promise<LatestProfileResponse> {
        ...
        return this.client.get(`/vsac/program/${encodeURIComponent(programName)}/latest profile`) as Promise<LatestProfileResponse>;
    }
