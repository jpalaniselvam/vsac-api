...
describe('UtilitySDK - E2E Integration Tests', () => {
    ...
    describe('getProgram', () => {
        ...
        it('should throw error for invalid program name', async () => {
    ...
    describe('getOidPrograms', () => {
        it('should get oid programs', async () => {
        ...
        it('should get zero programs for invalid oid', async () => {
    ...
    describe('getOidProgram', () => {
        it('should get oid program', async () => {
        ...
        it('should throw error for invalid data', async () => {
            ...
            await expect(sdk.getOidProgram('invalid oid', 'CMS eCQM and Hybrid Measure')).rejects.toThrow();
            await expect(sdk.getOidProgram(TEST_OID, 'invalid program name')).rejects.toThrow();
        }, timeout);
    })

    describe('getOidVersions', () => {
        it('should get oid versions', async () => {
        ...
        it('should get empty list for invalid oid', async () => {
    ...
    describe('getProgramLatestProfile', () => {
        it('should get program latest profile', async () => {
        ...
        it('should get empty response with no name field for invalid program name   ', async () => {
    ...
    describe('getTagValues', () => {
        it('should get tag values', async () => {
        ...
        it('should get empty response with no value field for invalid tag name', async () => {
