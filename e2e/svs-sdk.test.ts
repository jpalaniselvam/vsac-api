...
describe('SVSClient - E2E Integration Tests', () => {
    ...
    describe('retrieveValueSet', () => {
        it('should retrieve value set by ID', async () => {
    ...
    describe('retrieveMultipleValueSets', () => {
        it('should retrieve value set metadata by ID', async () => {
        ...
        it('should retrieve value set by ID and version', async () => {
        ...
        it('should retrieve value set by ID and profile', async () => {
            const response = await sdk.retrieveMultipleValueSets({
                id: RACE_OID,
        ...
        it('should retrieve value set by ID and effective date', async () => {
            try {
                const response = await sdk.retrieveMultipleValueSets({
                    id: RACE_OID,
        ...
        it('should retrieve value set by ID, effective date and program type', async () => {
            try {
                const response = await sdk.retrieveMultipleValueSets({
                    id: RACE_OID,
                    effectiveDate: TEST_EFFECTIVE_DATE,
        ...
        it('should retrieve value set by tag name and value', async () => {
            try {
                const response = await sdk.retrieveMultipleValueSets({
