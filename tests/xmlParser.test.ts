...
describe('XmlParser - Unit Tests', () => {
    ...
    describe('parse - Valid XML', () => {
        ...
        it('should parse numeric attribute values', () => {
            const xml = '<?xml version="1.0"?><root count="42" price="19.99" active="true"><item/></root>';
            const result = parser.parse(xml) as any;
    ...
    describe('parse - Edge Cases', () => {
        ...
        it('should parse XML with special characters in text', () => {
            const xml = '<?xml version="1.0"?><root><item>Text with &lt; &gt; &amp; &quot; &apos;</item></root>';
            const result = parser.parse(xml) as any;
    ...
    describe('parse - Real-world VSAC XML Examples', () => {
        it('should parse RetrieveValueSet response', () => {
            ...
            expect(result['ns0:RetrieveValueSetResponse']).toBeDefined();
            expect(result['ns0:RetrieveValueSetResponse']['ns0:ValueSet']._ID).toBe('2.16.840.1.114222.4.11.837');
            expect(result['ns0:RetrieveValueSetResponse']['ns0:ValueSet']['ns0:ConceptList']).toBeDefined();
            expect(result['ns0:RetrieveValueSetResponse']['ns0:ValueSet']['ns0:ConceptList']['ns0:Concept']).toBeDefined();
            expect(result['ns0:RetrieveValueSetResponse']['ns0:ValueSet']['ns0:ConceptList']['ns0:Concept']._code).toBe('2135-2');
        });
